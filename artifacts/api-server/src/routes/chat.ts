...
- Bulk Import: Import an entire existing image archive in one step. Go to "Bulk Import" in the sidebar. Upload a ZIP file containing patient subfolders (e.g. 2116/photo1.jpg) and an optional CSV file with patient details (columns: patient ID, name, date of birth). A single root wrapper folder inside the ZIP (e.g. foto/2116/photo1.jpg) is detected and skipped automatically. The importer creates new patients or matches existing ones by patient code, extracts capture dates from EXIF data when available, and reports a summary of patients created, patients matched, images imported, and any errors.
